...
public class PuzzleRacePlayer : MonoBehaviour
{    
        [NonSerialized]
        ...
        void Update(){
            ...
            if (data.id == 0 && InputMaster.GetKeyDown(KeyCode.X)){
                InputSensor.TriggerKey(KeyCode.X, 0);
            }
            ...
            if (data.id == 1 && InputMaster.GetKeyDown(KeyCode.C)){
                InputSensor.TriggerKey(KeyCode.X, 1);
            }
        }
}